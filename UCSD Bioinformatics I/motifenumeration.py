...
seqs = ['GTAAGTGTAGAGATTACGCTAAGGT','ATGTAGCAAGTATAAGTTTTACGCG','GGAAGATAATGCCTACTGCTACCAC','TGCTTTTACGTCGCCCGAGGGTAAG','CTGCCTCCGCGGAAGCTGCATTGCC','GTGAATGCTTGTAATTTGTGGCAAG']
ans = MotifEnumeration(seqs,5,1)
