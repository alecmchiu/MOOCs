...
class MITCampus(Campus):
    ...
    def remove_tent(self, tent_loc):
        ...
        for tent in self.tent_list:
        	if tent == tent_loc:
        		...
        		return
        raise ValueError("There is no tent at that location.")
    ...
    def get_tents(self):
        ...
        tent_list_str = []
        for each in self.tent_list:
        	tent_list_str.append(str(each))
        return(sorted(tent_list_str))
